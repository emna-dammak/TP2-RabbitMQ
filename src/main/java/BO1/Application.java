...
public class Application {
    static String path = "C:\\Users\\emnad\\Desktop\\TP2\\src\\main\\java\\BO1\\Actions.txt" ;

    public static void main(String[] args)
    {
        String url = "jdbc:mysql://localhost:3306/product_salesdb?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useSSL=false" ;
        String user = "root" ;
